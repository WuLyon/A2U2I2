...
function pub_SendCodexml(phone)
{
	//配置函数所需参数
	var para={
		url:'http://wetennis.cn:83/WebService/SMS.ashx?typename=GenerateCodeXML&userid=admin&secret=12837216371623',
		ready:function(){},
		params:"tele="+phone
	}		
...
{
	var para={
			url:'http://wetennis.cn:83/WebService/SMS.ashx?typename=ValidateCodeXML&userid=admin&secret=1234567',
			ready:function(){},
...
{
	var para={
			url:'http://wetennis.cn:83/WebService/WeMember.ashx?typename=ValidateClubLogin',
			ready:function(){},
...
{
	var para={
			url:'http://wetennis.cn:83/WebService/WeNews.ashx?typename=LoadNewsXml&userid='+pub_user+'&secret='+pub_pwd,
			ready:function(){},
...
function pub_Register()
{
	...
	$.ajax({
		async:"false",
		type:"POST",
		url:"http://wetennis.cn:83/BackService/TourMgmJson.ashx?typename=RegisterClub",
